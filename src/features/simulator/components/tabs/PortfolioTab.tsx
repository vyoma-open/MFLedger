      ...
      <div className="sim-layout">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div className="card" style={{ padding: 'var(--space-6)', display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              <div style={{ background: 'var(--surface-2)', border: '1px solid var(--border-subtle)', borderRadius: 8, padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 4 }}>
                <div style={{ fontSize: 11, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600 }}>Initial Lumpsum (Locked)</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'var(--font-mono)' }}>
                  {formatINR(currentPortfolioValue * 100)}
                </div>
                <div style={{ fontSize: 10, color: 'var(--text-secondary)' }}>
                  Automatically pre-filled and locked to your live holdings balance.
                </div>
              </div>
            </div>
